...
export default function BookRide({
  ...
  const fare = activeDriver ? (FARE_MAP[activeDriver.vehicleType] ?? "₦400") : "₦400";
  const fareAmount = fare === "Free" ? "0" : fare.replace(/[₦,]/g, "");
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-right shrink-0">
                            <div className="text-sm font-bold" style={{ color: "var(--color-primary)" }}>{FARE_MAP[driver.vehicleType] ?? "₦400"}</div>
